...
public class Factory extends Thread{
    ...
    public void run(){
        ...
        screen_producer_semaphore = new Semaphore(Integer.parseInt(data.split(",")[3].split("=")[1]));
        button_producer_semaphore = new Semaphore(Integer.parseInt(data.split(",")[13].split("=")[1].split("}")[0]));
        pin_producer_semaphore = new Semaphore(Integer.parseInt(data.split(",")[6].split("=")[1]));
        ...
        while(this.stop){
            ...
            Warehouse screen_warehouse = new Warehouse(Integer.parseInt(data.split(",")[7].split("=")[1]),"pantalla", 0, simulation);
            simulation.button_warehouse_current_stock3.setText(Integer.toString(screen_warehouse.getSize()));

            Warehouse button_warehouse = new Warehouse(Integer.parseInt(data.split(",")[4].split("=")[1]),"botton", 0, simulation);
            simulation.button_warehouse_current_stock1.setText(Integer.toString(screen_warehouse.getSize()));

            Warehouse pin_warehouse = new Warehouse(Integer.parseInt(data.split(",")[1].split("=")[1]),"pin", 0, simulation);
            simulation.button_warehouse_current_stock2.setText(Integer.toString(screen_warehouse.getSize()));

            Warehouse camera_warehouse = new Warehouse(Integer.parseInt(data.split(",")[2].split("=")[1]),"camara", 0, simulation);
            simulation.button_warehouse_current_stock4.setText(Integer.toString(screen_warehouse.getSize()));

                for (int i = 0; i < Integer.parseInt(data.split(",")[3].split("=")[1]); i++) {
                    Productores productor_pantalla = new Productores(Integer.parseInt(data.split(",")[3].split("=")[1]), "pantalla", i+1, Integer.parseInt(data.split(",")[5].split("=")[1]), screen_warehouse, 0, screen_producer_semaphore, true, simulation, 0, counter, number_camera_producers, number_pin_producers, number_button_producers, number_screen_producers);
                ...
                simulation.screen_producer_label.setText(Integer.toString(Integer.parseInt(data.split(",")[3].split("=")[1])));

                for (int i = 0; i < Integer.parseInt(data.split(",")[13].split("=")[1].split("}")[0]); i++) {
                    Productores productor_boton = new Productores(Integer.parseInt(data.split(",")[13].split("=")[1].split("}")[0]), "boton", i+1, Integer.parseInt(data.split(",")[8].split("=")[1]), button_warehouse, 0, button_producer_semaphore, true, simulation, 0, counter, number_camera_producers, number_pin_producers, number_button_producers, number_screen_producers);
                ...
                simulation.button_producer_label.setText(Integer.toString(Integer.parseInt(data.split(",")[13].split("=")[1].split("}")[0])));

                for (int i = 0; i < Integer.parseInt(data.split(",")[6].split("=")[1]); i++) {
                    Productores productor_pin = new Productores(Integer.parseInt(data.split(",")[6].split("=")[1]), "pin", i+1, Integer.parseInt(data.split(",")[10].split("=")[1]), pin_warehouse, 0, pin_producer_semaphore, true, simulation, 0, counter, number_camera_producers, number_pin_producers, number_button_producers, number_screen_producers);
                ...
                simulation.pin_producer_label.setText(Integer.toString(Integer.parseInt(data.split(",")[6].split("=")[1])));

                for (int i = 0; i < Integer.parseInt(data.split(",")[11].split("=")[1]); i++) {
                    Productores productor_camara = new Productores(Integer.parseInt(data.split(",")[11].split("=")[1]), "camara", i+1, Integer.parseInt(data.split(",")[12].split("=")[1]), camera_warehouse, 0, camera_producer_semaphore, true, simulation, 0, counter, number_camera_producers, number_pin_producers, number_button_producers, number_screen_producers);
                ...
                simulation.number_camera_label.setText(Integer.toString(Integer.parseInt(data.split(",")[11].split("=")[1])));

                for (int i = 0; i < Integer.parseInt(data.split(",")[0].split("=")[1]); i++) {
                ...
                Boss boss = new Boss(7, 0, 1, true, Integer.parseInt(data.split(",")[9].split("=")[1]), counter_semaphore,  boss_manager_semaphore, simulation, counter, data);
